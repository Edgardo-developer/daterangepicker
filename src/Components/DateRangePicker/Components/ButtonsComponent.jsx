...
const ButtonsComponent = (props) => {
    ...
    return (
        <div className={classes.visualInputss}>
          <div className={formStyles.input_module + ' ' + classes.input_check_in + ' ' + ((popupType === 'check_in') ? classes.input_module_active : '')}
               onClick={ function (e){
            ...
            <div className={formStyles.input_module + ' ' + classes.input_check_out + ' ' + ((popupType === 'check_out') ? classes.input_module_active : '')} onClick={ function (e){
